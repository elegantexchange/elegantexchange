export default function PageHeader({ title, subtitle, actions, testid }) {
  return (
    <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-x-3 gap-y-1 mb-6 md:mb-8">
      <h1
        data-testid={testid || "page-title"}
        className="col-span-2 lg:col-span-1 ee-page-title text-[28px] md:text-[32px] leading-tight tracking-[-0.02em] whitespace-nowrap"
      >
        {title}
      </h1>
      {subtitle ? (
