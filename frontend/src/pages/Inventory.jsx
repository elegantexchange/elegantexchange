    ...
    <div className="px-6 md:px-10 py-8">
      ...
      <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-1">
        ...
        <div className="relative shrink-0 w-56 min-w-[12rem]">
          ...
          <Input
            ...
            placeholder="Search item ID, description, consignor…"
            className="pl-9"
          />
        </div>
      ...
      {selected.size > 0 && (
        <div
          ...
          className="bg-[var(--ee-magenta-soft)] border border-[var(--ee-magenta)] rounded-md px-4 py-2 mb-4 flex flex-wrap items-center gap-2"
        >
          <span className="text-sm font-semibold text-[var(--ee-magenta)]">
